...
<section class=" slider_section position-relative">
    <div class="design-box">
      <img src="{{ asset('assets/home/images/design-1.png') }}" alt="">
    </div>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="img-box">
                  <img src="{{ asset('assets/home/images/slider-img.png') }}" alt="">
                </div>
              </div>
            </div>
          </div>
...
<div class="item_section layout_padding2">
  ...
  <section class="about_section layout_padding2-top layout_padding-bottom">
    <div class="design-box">
      <img src="{{ asset('assets/home/images/design-2.png') }}" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <div class="img-box">
            <img src="{{ asset('assets/home/images/about-img.png') }}" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="ring_container layout_padding2">
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="img-box">
              <img src="{{ asset('assets/home/images/ring-img.jpg') }}" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="client_container">
              <div class="client-id">
                <div class="img-box">
                  <img src="{{ asset('assets/home/images/client.png') }}" alt="">
                </div>
                <div class="name">
                  <h5>
                    Aliqua
